...
const char* ei_classifier_inferencing_categories[] = { "running_forearm", "sitting_forearm", "standing_forearm", "walking_forearm" };
...
const ei_impulse_t impulse_611966_0 = {
    .project_id = 611966,
    .project_owner = "Ankit Barnwal",
    .project_name = "activity_detector",
    .impulse_id = 1,
    ...
    .fusion_string = "attr_x + attr_y + attr_z",
    .slice_size = (50/4),
...
ei_impulse_handle_t impulse_handle_611966_0 = ei_impulse_handle_t( &impulse_611966_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_611966_0;
